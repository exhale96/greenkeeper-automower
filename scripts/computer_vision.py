...
imgsz = 640  # Image size for YOLO & MiDaS processing
confidence = 0.5 # Model only outputs objects detected with confidence equal or higher. 
classes = None 
iou = 0.75
half = False
agnostic_nms = False
...
def process_frame_with_midas(picam2):
